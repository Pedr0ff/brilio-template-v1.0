...
const Footer = ({ className = "footer-area", copyrightText = "©2025 Stel'R, All Rights Reserved By", linkText = "Stel'R Prod", linkUrl = "", scrollToTopText = "Revenir au dessus", scrollToTopTarget = "#header" }) => {
	return (
